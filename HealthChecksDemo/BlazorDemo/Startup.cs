    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHealthChecks() 
                ...
                //    HealthCheckResult.Degraded("The check of the foo service did not work well"), new[] { "service" })
                ...
                .AddCheck("Database Service", () =>
                    HealthCheckResult.Healthy("The check of the database"), new[] { "database", "sql" });




            services.AddSingleton<WeatherForecastService>();
            // "Singleton" - We get one instance and will use it for the life of application which allows to keep state between our calls
